...
SEED_POIS: dict = {
    "hospital_er": [
        ...
        {"name": "Hospital Infanta Leonor", "address": "Av. Gran Vía del Este, 80, Vallecas", "lat": 40.3835, "lon": -3.6053},
        {"name": "Hospital Universitario Fundación Alcorcón", "address": "C. Budapest, 1, Alcorcón", "lat": 40.3567, "lon": -3.8409},
        {"name": "Hospital Severo Ochoa", "address": "Av. de Orellana, s/n, Leganés", "lat": 40.3336, "lon": -3.7654},
        {"name": "Hospital Rey Juan Carlos", "address": "C. Gladiolo, s/n, Móstoles", "lat": 40.3227, "lon": -3.8797},
        {"name": "Hospital Universitario de Getafe", "address": "Ctra. de Toledo km 12,5, Getafe", "lat": 40.3084, "lon": -3.7264},
        {"name": "Hospital Universitario de Fuenlabrada", "address": "C. Camino del Molino, 2", "lat": 40.2820, "lon": -3.8106},
        {"name": "Hospital Infanta Sofía", "address": "P.º de Europa, 34, San Sebastián de los Reyes", "lat": 40.5510, "lon": -3.6284},
        {"name": "Fundación Jiménez Díaz", "address": "Av. de los Reyes Católicos, 2", "lat": 40.4373, "lon": -3.7231},
        {"name": "Hospital Niño Jesús (urgencias pediátricas)", "address": "Av. de Menéndez Pelayo, 65", "lat": 40.4143, "lon": -3.6800},
        {"name": "Hospital Universitario Sanitas La Zarzuela", "address": "C. Pléyades, 25, Aravaca", "lat": 40.4507, "lon": -3.7737},
        {"name": "Hospital HM Sanchinarro", "address": "C. de Oña, 10", "lat": 40.4894, "lon": -3.6620},
    ],
    "pharmacy_24": [
    ...
    "fuel_24": [
        ...
        {"name": "Repsol López de Hoyos", "address": "C. de López de Hoyos, 143", "lat": 40.4517, "lon": -3.6739},
        {"name": "Cepsa Arturo Soria", "address": "C. de Arturo Soria, 122", "lat": 40.4488, "lon": -3.6470},
        {"name": "Repsol Manuel Becerra", "address": "Plaza de Manuel Becerra", "lat": 40.4291, "lon": -3.6706},
        {"name": "Shell Delicias", "address": "P.º de las Delicias, 84", "lat": 40.4008, "lon": -3.6947},
        {"name": "BP Doctor Esquerdo", "address": "C. del Dr. Esquerdo, 62", "lat": 40.4205, "lon": -3.6704},
        {"name": "Repsol Paseo Extremadura", "address": "P.º de Extremadura, 200", "lat": 40.3960, "lon": -3.7590},
        {"name": "Galp Legazpi", "address": "Plaza de Legazpi", "lat": 40.3910, "lon": -3.6957},
        {"name": "Cepsa Manzanares", "address": "Av. de Manzanares, 178", "lat": 40.3852, "lon": -3.7166},
        {"name": "Repsol Ilustración", "address": "Av. de la Ilustración, 60", "lat": 40.4735, "lon": -3.7108},
        {"name": "BP María de Molina", "address": "C. de María de Molina, 27", "lat": 40.4384, "lon": -3.6810},
        {"name": "Repsol San Bernardo", "address": "C. de San Bernardo, 118", "lat": 40.4304, "lon": -3.7075},
        {"name": "Cepsa Reina Victoria", "address": "Av. Reina Victoria, 38", "lat": 40.4470, "lon": -3.7091},
        {"name": "Repsol Aeropuerto Barajas T4", "address": "Aeropuerto Adolfo Suárez T4", "lat": 40.4936, "lon": -3.5668},
        {"name": "Repsol M-30 (Ntra. Sra. de Valvanera)", "address": "Av. Ntra. Sra. de Valvanera", "lat": 40.4014, "lon": -3.6788},
    ],
    "tobacco_24": [
    ...
    "nightclub": [
        ...
        {"name": "Panda Club", "address": "C. de Preciados, 40", "lat": 40.4210, "lon": -3.7061},
        {"name": "Marula Café", "address": "C. de Caños Viejos, 3", "lat": 40.4130, "lon": -3.7101},
        {"name": "Independance Club", "address": "Plaza del Callao, 4", "lat": 40.4198, "lon": -3.7060},
        {"name": "But Club", "address": "C. de Barceló, 11 (planta baja)", "lat": 40.4257, "lon": -3.6993},
        {"name": "Opium Madrid", "address": "C. de José Abascal, 56", "lat": 40.4383, "lon": -3.6963},
        {"name": "Uñas Chung Lee", "address": "Ronda de Valencia, 4", "lat": 40.4062, "lon": -3.6952},
        {"name": "Sala Nazca", "address": "C. de Fuencarral, 43", "lat": 40.4241, "lon": -3.7024},
        {"name": "Discoteca Bellucci", "address": "C. de la Cruz, 11", "lat": 40.4160, "lon": -3.7025},
        {"name": "Sala Riviera", "address": "P.º Bajo de la Virgen del Puerto", "lat": 40.4113, "lon": -3.7208},
        {"name": "Cool Club", "address": "C. de Isabel la Católica, 6", "lat": 40.4210, "lon": -3.7079},
        {"name": "Sala Fórmula", "address": "C. de las Fuentes, 3", "lat": 40.4171, "lon": -3.7099},
        {"name": "Discoteca Copérnico", "address": "C. de Fernández de los Ríos, 67", "lat": 40.4360, "lon": -3.7133},
        {"name": "Boccaccio Club", "address": "C. del Marqués de la Ensenada, 16", "lat": 40.4245, "lon": -3.6903},
        {"name": "Le Club Metropolitan", "address": "Av. Concha Espina, 1 (Bernabéu)", "lat": 40.4531, "lon": -3.6883},
    ],
}
